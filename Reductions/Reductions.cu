...
void reduce5_wrapper(T *g_idata, T *g_odata, unsigned int N, int NumBlocks, int NumThreads, int smemSize)
{
    ...
    {
    case 512:
        reduce5<T, 512><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
        break;
    case 256:
        reduce5<T, 256><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
        break;
    case 128:
        reduce5<T, 128><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
        break;
    case 64:
        reduce5<T, 64><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
        break;
    case 32:
        reduce5<T, 32><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
        break;
    case 16:
        reduce5<T, 16><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
        break;
    case 8:
        reduce5<T, 8><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
        break;
    case 4:
        reduce5<T, 4><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
        break;
    case 2:
        reduce5<T, 2><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
        break;
    case 1:
        reduce5<T, 1><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
        break;
...
void reduce6_wrapper(T *g_idata, T *g_odata, unsigned int N, int NumBlocks, int NumThreads, int smemSize)
{
    if (isPow2(N))
    {
        ...
        {
        case 512:
            reduce6<T, 512, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 256:
            reduce6<T, 256, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 128:
            reduce6<T, 128, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 64:
            reduce6<T, 64, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 32:
            reduce6<T, 32, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 16:
            reduce6<T, 16, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 8:
            reduce6<T, 8, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 4:
            reduce6<T, 4, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 2:
            reduce6<T, 2, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 1:
            reduce6<T, 1, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        }
        gpuErrchk(cudaPeekAtLastError());
        gpuErrchk(cudaDeviceSynchronize());
    ...
    else
    {
        ...
        {
        case 512:
            reduce6<T, 512, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 256:
            reduce6<T, 256, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 128:
            reduce6<T, 128, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 64:
            reduce6<T, 64, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 32:
            reduce6<T, 32, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 16:
            reduce6<T, 16, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 8:
            reduce6<T, 8, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 4:
            reduce6<T, 4, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 2:
            reduce6<T, 2, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 1:
            reduce6<T, 1, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        }
        gpuErrchk(cudaPeekAtLastError());
        gpuErrchk(cudaDeviceSynchronize());
...
void reduce_threadfence_wrapper(T *g_idata, T *g_odata, unsigned int N, int NumBlocks, int NumThreads, int smemSize)
{
    if (isPow2(N))
    {
        ...
        {
        case 512:
            reduceSinglePass<T, 512, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 256:
            reduceSinglePass<T, 256, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 128:
            reduceSinglePass<T, 128, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 64:
            reduceSinglePass<T, 64, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 32:
            reduceSinglePass<T, 32, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 16:
            reduceSinglePass<T, 16, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 8:
            reduceSinglePass<T, 8, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 4:
            reduceSinglePass<T, 4, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 2:
            reduceSinglePass<T, 2, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 1:
            reduceSinglePass<T, 1, true><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        }
        gpuErrchk(cudaPeekAtLastError());
        gpuErrchk(cudaDeviceSynchronize());
    ...
    else
    {
        ...
        {
        case 512:
            reduceSinglePass<T, 512, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 256:
            reduceSinglePass<T, 256, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 128:
            reduceSinglePass<T, 128, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 64:
            reduceSinglePass<T, 64, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 32:
            reduceSinglePass<T, 32, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 16:
            reduceSinglePass<T, 16, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 8:
            reduceSinglePass<T, 8, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 4:
            reduceSinglePass<T, 4, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 2:
            reduceSinglePass<T, 2, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        case 1:
            reduceSinglePass<T, 1, false><<<NumBlocks, NumThreads, smemSize>>>(g_idata, g_odata, N);
            break;
        }
        gpuErrchk(cudaPeekAtLastError());
        gpuErrchk(cudaDeviceSynchronize());
...
int main()
{
    ...
    for (int i = 0; i < NumBlocks; i++)
        sum_reduce0 = sum_reduce0 + h_vec_block[i];
    ...
    int sum_reduce1 = 0;
    for (int i = 0; i < NumBlocks; i++)
        sum_reduce1 = sum_reduce1 + h_vec_block[i];
    ...
    int sum_reduce2 = 0;
    for (int i = 0; i < NumBlocks; i++)
        sum_reduce2 = sum_reduce2 + h_vec_block[i];
    ...
    int sum_reduce3 = 0;
    for (int i = 0; i < NumBlocks; i++)
        sum_reduce3 = sum_reduce3 + h_vec_block[i];
    ...
    int sum_reduce4 = 0;
    for (int i = 0; i < NumBlocks; i++)
        sum_reduce4 = sum_reduce4 + h_vec_block[i];
    ...
    int sum_reduce5 = 0;
    for (int i = 0; i < NumBlocks; i++)
        sum_reduce5 = sum_reduce5 + h_vec_block[i];
    ...
    int sum_reduce6 = 0;
    for (int i = 0; i < NumBlocks; i++)
        sum_reduce6 = sum_reduce6 + h_vec_block[i];
    ...
    for (int i = 0; i < NumBlocks; i++)
        sum_reduce4_no_synchthreads = sum_reduce4_no_synchthreads + h_vec_block[i];
    ...
    for (int i = 0; i < NumBlocks; i++)
        sum_reduce4_deadlock = sum_reduce4_deadlock + h_vec_block[i];
    ...
    for (int i = 0; i < NumBlocks; i++)
        sum_reduce4_atomicWarp = sum_reduce4_atomicWarp + h_vec_block[i];
    ...
    for (int i = 0; i < NumBlocks; i++)
        sum_reduce0_stackoverflow = sum_reduce0_stackoverflow + h_vec_block[i];
